...
public class ResQAutonomousBlueFar extends TwoMotorDriveOpMode{
    ...
    public void runOpMode() throws InterruptedException{
        ...
        setDrive(driveMotors.angleToInch(90), .5, DriveDirections.RIGHT);
        waitSeconds(2);
        driveMotors.stop();
        ...
        setDrive(driveMotors.angleToInch(30), .5, DriveDirections.LEFT);
        waitSeconds(2);
        driveMotors.stop();
