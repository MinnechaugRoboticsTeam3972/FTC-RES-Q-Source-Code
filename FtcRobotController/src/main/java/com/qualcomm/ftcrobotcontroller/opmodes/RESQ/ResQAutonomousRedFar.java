...
public class ResQAutonomousRedFar extends TwoMotorDriveOpMode{
    ...
    public void runOpMode() throws InterruptedException{
        ...
        telemetry.addData("Checkpoint", "Aligning to approach");
        setDrive(driveMotors.angleToInch(90), .5, DriveDirections.LEFT);
        waitSeconds(2);
        driveMotors.stop();

        setDrive(24, .5, DriveDirections.BACKWARDS);
        waitSeconds(3);
        driveMotors.stop();

        telemetry.addData("Checkpoint", "Angling");
        setDrive(driveMotors.angleToInch(30), .5, DriveDirections.RIGHT);
        waitSeconds(2);
        driveMotors.stop();

        servoLeft.setPosition(ServoConfig.LEFT_OUT.position);
        servoRight.setPosition(ServoConfig.RIGHT_IN.position);
        ...
        setDrive(driveMotors.angleToInch(100), .5, DriveDirections.RIGHT);
        waitSeconds(2);
        driveMotors.stop();
